...
public class Dijkstra {
    public static void main(String[] args) {
        ...
        graph.put(1, List.of(new Edge(2, 2), new Edge(4, 1)));
        graph.put(2, List.of(new Edge(3, 2), new Edge(5, 1), new Edge(6, 4)));
        graph.put(3, List.of(new Edge(6, 4)));
        graph.put(4, List.of(new Edge(7, 5)));
        graph.put(5, List.of(new Edge(8, 1)));
        graph.put(6, List.of(new Edge(5, 3)));
        graph.put(7, List.of(new Edge(6, 7), new Edge(8, 6)));
        graph.put(8, List.of());
